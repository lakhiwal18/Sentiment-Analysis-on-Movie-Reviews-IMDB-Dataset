# -*- coding: utf-8 -*-
"""IMDB__naive_bayes__with__TF_IDF.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zX1ZfFTOeepxDNPV_FhwxMTFOYIDgBdN
"""
...
MN = MultinomialNB()
MN.fit(tfidf_x_train,y_train)
y_pred = MN.predict(tfidf_x_test)

y_pred_val = MN.predict(tfidf_x_val)
...
from sklearn.metrics import accuracy_score, precision_score, recall_score, f1_score, confusion_matrix
y_pred_test = MN.predict(tfidf_x_test)
...
MN_train_loss = 1 - accuracy_score(y_train, MN.predict(tfidf_x_train))
MN_val_loss = 1 - accuracy_score(y_val, MN.predict(tfidf_x_val))
print("Naive Bayes training loss: {:.2f}".format(MN_train_loss))
print("Naive Bayes validation loss: {:.2f}".format(MN_val_loss))